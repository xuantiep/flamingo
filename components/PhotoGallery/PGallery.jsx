  ...
  data: [
    {
      ...
      description:
        "This article was modified on Jan 4. 2021 to update the recent changes in food prices."
    },
    {
      type: "article-text",
      description:
        "This is a caption with *italics* and **bold** font. The impact of the fast food industry on America cannot be underestimated."
    },
    {
      type: "center-photo",
      img_url:
        "https://wp.dailybruin.com/images/galleries/traditions-o-issue/4.JDS_.jpg",
      description:
    ...
    },
    {
      type: "alt-photo",
      img_url:
        "https://brand.ucla.edu/images/identity/logos-and-marks/script-logo.jpg",
      description:
        "“I would tell myself to not dwell and be hung up on problems that seem large at the time but, in reality, are so minuscule and incomparable to the real problems in the world,” Wong said.",
      credits: "Jonathan Sylvester"
    },
    {
      ...
      description:
        "“All of the things I’ve done were so that I can live without regrets,” Chen said. “This year’s experience has revealed the importance of this mindset even more profoundly.”",
    ...
    },
    {
      type: "center-photo",
      img_url:
        "https://static2.cbrimages.com/wordpress/wp-content/uploads/2020/02/Burger-King-mascot-header.png?q=50&fit=crop&w=960&h=500&dpr=1.5",
    ...
    },
    {
      type: "center-photo",
      img_url:
        "https://image.freepik.com/free-photo/vertical-view-eiffel-tower-paris-france_1258-3169.jpg",
    ...
    },
    {
      type: "center-photo",
      img_url:
        "https://photos.mandarinoriental.com/is/image/MandarinOriental/new-york-2017-columbus-circle-01?wid=1100&hei=733&fmt=jpeg&qlt=75,0&op_sharpen=0&resMode=sharp2&op_usm=1,1,5,0&iccEmbed=0&printRes=72&fit=crop",
      description: "Skyline",
...
var dummyDataBig = {
  ...
  data: [
    ...
    },
    {
      type: "article-text",
      description:
        "**Catalina Island** is a popular attraction in California.**Catalina Island** is a popular attraction in California.**Catalina Island** is a popular attraction in California.**Catalina Island** is a popular attraction in California.**Catalina Island** is a popular attraction in California.**Catalina Island** is a popular attraction in California."
    },
    {
      type: "big-center-photo",
